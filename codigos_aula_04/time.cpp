...
int main() {
  Time t(10, 13, 56); // Cria um objeto Time com hora = 10, minuto = 13 e segundo = 56
  t.print(); // Imprime a hora atual
  t.nextSecond(); // Avança para o próximo segundo
  t.print(); // Imprime a hora atualizada
  return 0;
}

// compilar: g++ time.cpp -o time
// executar: ./time